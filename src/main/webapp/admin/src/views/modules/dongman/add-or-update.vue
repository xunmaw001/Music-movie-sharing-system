        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.dongmanPhoto" label="动漫照片" prop="dongmanPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.dongmanPhoto?ruleForm.dongmanPhoto:''"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="动漫类型" prop="dongmanTypes">
                        <el-select v-model="ruleForm.dongmanTypes" :disabled="ro.dongmanTypes" placeholder="请选择动漫类型">
                            <el-option
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   dongmanPhoto: [
                              { required: true, message: '动漫照片不能为空', trigger: 'blur' },
                          ],
                   dongmanTypes: [
                              { required: true, message: '动漫类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
